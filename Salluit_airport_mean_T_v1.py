...
for i, year in enumerate([2015,2016,2017]):
    ...
    # Group by month, mean, center at beginning of month using label
    monthly["mean"] = yearly_T.resample("M", label="left").mean()


    axes[i].set_ylabel(r"Mean T ($^\circ$C)")
    ...
    v = monthly["mean"].loc[monthly["mean"] <= 0]
