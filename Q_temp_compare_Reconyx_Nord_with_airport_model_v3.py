...
axes[3].plot_date(v_date2num(mean_smoothed.index),mean_smoothed_again, linewidth=1 ,marker="",linestyle="-",color="k")
f_interp_one_period = interp1d(v_date2num(mean_smoothed.index), mean_smoothed_again, 'cubic')
print(mean_smoothed.index)
# axes[3].plot_date(v_date2num(mean_smoothed.index),f_interp_one_period(v_date2num(mean_smoothed.index)), linewidth=1 ,marker="",linestyle="-",color="g")
